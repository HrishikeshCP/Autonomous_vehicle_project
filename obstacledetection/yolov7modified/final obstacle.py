...
def check_intersection(masked_img1, masked_img2):
    ...
    if np.any(intersection != 0):
        print("Obstacle Entered Lane", obstacle_flag)
        if obstacle_flag == 1:
            print("Stop Vehicle!!!")
    return intersection
...
def detection():
    ...
    try:
        ...
        while True:
                ...
                if len(det):
                    ...
                    for *xyxy, _, _ in det:
                        ...
                        if object_distance < 3.0:
                            obstacle_flag = 1
                            print("obstacle detected in frame within distance!!!")
                        else:
                            obstacle_flag = 0
            ...
            if lane_masked_image.size != 0 and im0_masked.size != 0:
                intersection = check_intersection(lane_masked_image, im0_masked)
